...
public class NodeDataMsg {
    ...
    public record WriteLockGranted(int requestId, int version) implements Serializable {}

    public record WriteLockDenied(int requestId) implements Serializable {}

    public record WriteLockRelease(int requestId, int key) implements Serializable {}
}
